...
@app.route('/')
def upload_form():
    return render_template('upload_form.html', video_url="https://s1.ezgif.com/tmp/ezgif-1-f99bd52147.mp4")
    ...
    if response.status_code == 200:
        ...
        if status == "OK":
            ...
            if result_url:
                ...
                return render_template('upload_form.html', video_url=result_url)
            else:
